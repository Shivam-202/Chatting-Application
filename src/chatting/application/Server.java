 ...
 static JFrame f1 = new JFrame();
    Server(){
      ...
      f1.setLayout(null);
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/chatImg/shivam.jpg"));
    ...
    public static JPanel formatLabel(String app){
        ...
        JLabel l = new JLabel("<html><p style = \" width : 130px\">"+app+"</p></html>");
